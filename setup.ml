...
(* OASIS_START *)
(* DO NOT EDIT (digest: 78d2e120067f930bad598ac42282acee) *)
(*
...
let setup_t =
  {
            ...
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("$testytesty", []))];
     ...
     package =
       {
          ...
          description =
            Some
              [OASISText.Para "R programming language analysis framework."];
          tags = [];
          categories = [];
          files_ab = [];
          sections =
               ...
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_path = "src/smt/parser";
                      bs_compiled_object = Best;
                      bs_build_depends = [];
                      bs_build_tools =
                        [ExternalTool "ocamlbuild"; ExternalTool "ocamlfind"];
                   ...
                   {
                      lib_modules = ["Smtparser"; "Smtsyntax"];
                      lib_pack = false;
               ...
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_path = "src/smt";
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "smt-parser"];
                      bs_build_tools =
                        [ExternalTool "ocamlbuild"; ExternalTool "ocamlfind"];
                      bs_interface_patterns =
                        [
                   ...
                   {
                      lib_modules = ["Smt2"; "Solver"; "Smtutils"; "Ismt"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = None;
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends = [InternalLibrary "parser"];
                      bs_build_tools =
                        [ExternalTool "ocamlbuild"; ExternalTool "ocamlfind"];
                      bs_interface_patterns =
                        [
                   ...
                   {exec_custom = false; exec_main_is = "absyn_generator.ml"});
               Library
                 ({
                     cs_name = "language";
                     cs_data = PropList.Data.create ();
                   ...
                   {
                      lib_modules = ["Syntax"; "Annotations"; "Langutils"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = None;
               ...
               Library
                 ({
                  ...
                  },
                   {
                      bs_build = [(OASISExpr.EBool true, true)];
                      bs_install = [(OASISExpr.EBool true, true)];
                      bs_path = "src/interpreter/interp-commons";
                      bs_compiled_object = Best;
                      bs_build_depends =
                        [InternalLibrary "language"; InternalLibrary "smt"];
                      bs_build_tools =
                        [ExternalTool "ocamlbuild"; ExternalTool "ocamlfind"];
                      bs_interface_patterns =
                        [
               ...
               Library
                 ({
                  ...
                  },
                   {
                      bs_build = [(OASISExpr.EBool true, true)];
                      bs_install = [(OASISExpr.EBool true, true)];
                      bs_path = "src/interpreter/natives";
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "interp-commons"];
                      bs_build_tools =
                        [ExternalTool "ocamlbuild"; ExternalTool "ocamlfind"];
                      bs_interface_patterns =
                        [
               ...
               Library
                 ({
                  ...
                  },
                   {
                      bs_build = [(OASISExpr.EBool true, true)];
                      bs_install = [(OASISExpr.EBool true, true)];
                      bs_path = "src/interpreter/preprocess";
                      bs_compiled_object = Best;
                      bs_build_depends =
                        [
                           InternalLibrary "parser";
                           InternalLibrary "interp-commons";
                           InternalLibrary "natives"
                        ];
                      bs_build_tools =
                        [ExternalTool "ocamlbuild"; ExternalTool "ocamlfind"];
                      bs_interface_patterns =
                   ...
                   {
                      lib_modules = ["Loader"; "Rast_to_language"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = None;
               ...
               Library
                 ({
                  ...
                  },
                   {
                      bs_build = [(OASISExpr.EBool true, true)];
                      bs_install = [(OASISExpr.EBool true, true)];
                      bs_path = "src/interpreter/stepper";
                      bs_compiled_object = Best;
                      bs_build_depends =
                        [
                           InternalLibrary "interp-commons";
               ...
               Library
                 ({
                  ...
                  },
                   {
                      bs_build = [(OASISExpr.EBool true, true)];
                      bs_install = [(OASISExpr.EBool true, true)];
                      bs_path = "src/interpreter";
                      bs_compiled_object = Best;
                      bs_build_depends =
                        [
                           InternalLibrary "interp-commons";
                           InternalLibrary "natives";
                           InternalLibrary "loader";
                           InternalLibrary "stepper"
                        ];
                      bs_build_tools =
                        [ExternalTool "ocamlbuild"; ExternalTool "ocamlfind"];
                      bs_interface_patterns =
                 ...
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           InternalLibrary "smt";
                           InternalLibrary "language";
                           InternalLibrary "interpreter";
                           InternalLibrary "loader";
                           InternalLibrary "natives"
                        ];
                      bs_build_tools =
                  ...
                  },
                   {
                      ...
                      test_tools =
                        [
                           ...
                           ExternalTool "ocamlfind";
                           InternalExecutable "testytesty"
                        ]
                   })
            ];
     ...
     oasis_digest = Some "\232\236R\158YCU\201O\136z\226\185\027\199C";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
