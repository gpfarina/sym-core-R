(* OASIS_START *)
(* DO NOT EDIT (digest: 221aa3661d05cfda99e969d60ecd6e94) *)
...
let package_default =
  {
     MyOCamlbuildBase.lib_ocaml =
       [
          ("smt-parser", ["src/smt/parser"], []);
          ("smt", ["src/smt"], []);
          ("parser", ["src/parser"], []);
          ("language", ["src/language"], []);
          ("interp-commons", ["src/interpreter/interp-commons"], []);
          ("natives", ["src/interpreter/natives"], []);
          ("loader", ["src/interpreter/preprocess"], []);
          ("stepper", ["src/interpreter/stepper"], []);
     ...
     includes =
       [
          ("test", ["src/interpreter"; "test/ounit"]);
          ("src/smt", ["src/smt/parser"]);
          ("src/interpreter/stepper",
            ["src/interpreter/interp-commons"; "src/interpreter/natives"]);
          ("src/interpreter/preprocess",
            [
               "src/interpreter/interp-commons";
               "src/interpreter/natives";
               "src/parser"
            ]);
          ("src/interpreter/natives", ["src/interpreter/interp-commons"]);
          ("src/interpreter/interp-commons", ["src/language"; "src/smt"]);
          ("src/interpreter",
            [
               "src/interpreter/interp-commons";
               "src/interpreter/natives";
